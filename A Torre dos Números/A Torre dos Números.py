...
# animar textos
#def animar_texto_multilinha(tela, cenario, texto, fonte_texto, cor_texto, x, y, max_largura, linha_altura, velocidade=50):
...
#        largura_teste, _ =fonte_texto.size(teste_linha)
...
#    texto_mostrado = [""] * len(linhas)

#    for i in range(len(linhas)):
#        for letra in linhas[i]:
#            texto_mostrado[i] += letra
#            for j, linha in enumerate(texto_mostrado):
#                superficie = fonte_texto.render(linha, True, cor_texto)
#                tela.blit(superficie, (x, y + j * linha_altura))
#            pygame.display.flip()    
