...
print()
sleep(3)
print("Taski: — Infelizmente, não consegui avançar pelo próximo andar.")           #   print("Taski: — Infelizmente, não consegui passar da porta deste andar.")
print()
sleep(3)
